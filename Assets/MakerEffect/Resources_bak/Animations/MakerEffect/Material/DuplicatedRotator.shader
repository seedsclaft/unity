...
Shader "EffekseerMaterial/DuplicatedRotator" {
...
_efk_texture_343_Tex("Color (RGBA)", 2D) = "white" {}
...
sampler2D _efk_texture_343_Tex;
...
float3 val0= vcolor.xyz;
float val4= vcolor.w;
float2 temp_2 = uv1;
float2 temp_1 = float2(0.5,0.5);
float temp_0 = float(0.0);
...
float2 temp_10 = float2(temp_7,temp_9);
float2 temp_11 = float2(temp_5,temp_7);
float2 temp_12 = (temp_2-temp_1);
float temp_13 = dot(temp_10,temp_12);
float2 temp_14 = (temp_2-temp_1);
float temp_15 = dot(temp_11,temp_14);
float2 temp_16 = float2(temp_13,temp_15);
float2 val5 = (temp_16+temp_1);
float4 val12 = ConvertFromSRGBTexture(tex2Dlod(_Color_Tex,float4(GetUV(val5),0,0)));
float val11=val12.w;
float3 val7=val12.xyz;
float val13=(val11*val4);
float3 val14= vcolor.xyz;
float val18= vcolor.w;
float val19=0.125;
float2 temp_19 = uv1;
float2 temp_18 = float2(0.5,0.5);
float temp_17 = val19;
float temp_20 = float(6.28318);
float temp_21 = (temp_20*temp_17);
float temp_22 = sin(temp_21);
float temp_23 = (temp_20*temp_17);
float temp_24 = cos(temp_23);
float temp_25 = float(0.0);
float temp_26 = (temp_25-temp_22);
float2 temp_27 = float2(temp_24,temp_26);
float2 temp_28 = float2(temp_22,temp_24);
float2 temp_29 = (temp_19-temp_18);
float temp_30 = dot(temp_27,temp_29);
float2 temp_31 = (temp_19-temp_18);
float temp_32 = dot(temp_28,temp_31);
float2 temp_33 = float2(temp_30,temp_32);
float2 val20 = (temp_33+temp_18);
float4 val26 = ConvertFromSRGBTexture(tex2Dlod(_efk_texture_343_Tex,float4(GetUV(val20),0,0)));
float val25=val26.w;
float3 val21=val26.xyz;
float val27=(val25*val18);
float val28=(val27+val13);
float3 val29=(val7*val0);
float3 val30=(val21*val14);
float3 val31=(val30+val29);
...
float2 temp_16 = float2(temp_13,temp_15);
float2 val5 = (temp_16+temp_1);
float4 val12 = ConvertFromSRGBTexture(tex2D(_Color_Tex,GetUV(val5)));
float val11=val12.w;
float3 val7=val12.xyz;
float val13=(val11*val4);
float3 val14= vcolor.xyz;
...
float2 temp_33 = float2(temp_30,temp_32);
float2 val20 = (temp_33+temp_18);
float4 val26 = ConvertFromSRGBTexture(tex2D(_efk_texture_343_Tex,GetUV(val20)));
float val25=val26.w;
float3 val21=val26.xyz;
float val27=(val25*val18);
float val28=(val27+val13);
