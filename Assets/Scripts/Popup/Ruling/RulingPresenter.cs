...
namespace Ryneus
{
    public class RulingPresenter : BasePresenter
    {
        ...
        private void Initialize()
        {
            ...
            _view.SetRuleCommand(MakeListData(_model.RulingCommand()));
            CommandRefresh();
            _view.CommandSelectRule(MakeListData(_model.RuleHelp()));
            _view.OpenAnimation();
            _busy = false;
        }
        ...
        {
            _view.CommandRefresh(MakeListData(_model.RuleHelp()));
        }
    }
}